...
public abstract class Operand
{
	 ...
	 * an instance of {@link AsmWarning}; this warning will then be handled by an instance of {@link AsmWarningHandler}.
	 * The reason for not using exception for warning handling is to avoid disturbance of execution of the application.
	 * 
